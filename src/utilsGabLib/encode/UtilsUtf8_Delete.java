 ...
 */
	...
	public static String replaceNoUTF8(String s)
	{
		...
		*/
	    ...
	    //s = s.replaceAll("€", "&#8364;");
	    s = s.replaceAll("\u20AC", "euros");
	    
	    s = s.replaceAll("’", "&#180;"); //Substituimos por el apostofre normal.
	    s = s.replaceAll("\u2019", "&#180;"); //Substituimos por el apostofre normal.´
	    s = s.replaceAll("\u201C", "_");
	   ...
	   // s = s.replaceAll("\u002F", "_"); //Substituimos por la barra normal
	...
	public static String replaceNoUTF8_v2(String s)
	{
		/*
		s = s.replaceAll("&","&amp;");
		s = s.replaceAll("<", "&lt;");
	...
	public static String normalizeText(String text){
		String regexp = generaRegExp_Normalize();
		String reemplazo ="_";
		text= text.replaceAll(regexp, reemplazo);
		return text;
	}
	
	
	public static String generaRegExp_Normalize(){
		
		String regexp = "[^a-zA-Z0-9<> \\\\:/\\n\\r\\t=\\.@\\%\"\\?áàéèíìóòúùÁÀÉÈÓÒÍÌÚÙ,#\\-\\(\\)€çÇñÑ\\*\\+!]";
	  //String regexp = "[^a-zA-Z0-9<> \\\\:/\\n\\r\\t=\\.@\\%\"\\?áàéèíìóòúùÁÀÉÈÓÒÍÌÚÙ,#\\-\\(\\)€çÇñÑ\\*]";
		//String regexp = "[^a-zA-Z0-9<> \\\\:/\\n\\r=\\.]";
